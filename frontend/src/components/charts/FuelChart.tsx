  ...
  return (
    <Card className="dashboard-card">
      <div className="dashboard-card__header" style={{ marginBottom: "16px" }}>
        <h2 className="dashboard-card__title">Fuel Level</h2>
      </div>
      <div style={{ width: "100%", height: 300 }}>
        <ResponsiveContainer>
          <LineChart data={formattedData} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
            ...
            />
            <Legend />
            <Line type="monotone" dataKey="fuel_level" name="Fuel Level (%)" stroke="var(--color-success)" strokeWidth={2} dot={false} activeDot={{ r: 6 }} />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </Card>
